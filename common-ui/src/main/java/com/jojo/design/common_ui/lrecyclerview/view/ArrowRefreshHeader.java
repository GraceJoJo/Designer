...
//            ProgressBar progressBar = new ProgressBar(getContext(), null, android.R.attr.progressBarStyle);
            IOSLoadingView iosLoadView = new IOSLoadingView(getContext(), null, android.R.attr.progressBarStyle);
            mProgressBar.setView(iosLoadView);
        } else {
...
//        return ct / 31104000 + getContext().getResources().getString(R.string.text_year_ago);
        ...
        return getContext().getString(R.string.text_today) + df.format(d);
    }
