...
public class LoadingFooter extends RelativeLayout implements ILoadMoreFooter {
    ...
    private int hintColor = R.color.color_app_yellow;
    ...
    public void init(Context context) {
        ...
        indicatorColor = ContextCompat.getColor(getContext(), R.color.color_app_yellow);
...
//            return new ProgressBar(getContext(), null, android.R.attr.progressBarStyle);
            return new IOSLoadingView(getContext(), null, android.R.attr.progressBarStyle);
        } else {
