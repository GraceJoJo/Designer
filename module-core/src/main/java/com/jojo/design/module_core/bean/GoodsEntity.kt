 ...
 *    desc   : 逛（列表商品的实体）
 */
data class GoodsEntity(val id: Int, val h5Url: String, val image: String, val items: List<ItemProductBean>, val name: String, var title: String) : Serializable {
    data class ItemProductBean(var id: String, val brandName: String, val image: String, val keyword: String, val price: String) : Serializable
